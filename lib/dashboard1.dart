import 'package:app_proyek/pilihanKamar1.dart';
import 'package:app_proyek/single1.dart';
...
class Dashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "/single1": (context) => Single(),
        "/pilihanKamar1": (context) => PilihanKamar(), // Add this route for detail page
      },
      title: 'Dashboard',
      theme: ThemeData(
              ...
              Row(
                children: [
                  ...
                  CategoryButton(
                    ...
                    label: 'Single',
                    onTap: () {
                      Navigator.pushNamed(context, "/single1");
                    },
                  ),
                ],
              ),
              ...
              ListView(
                ...
                children: [
                  RecommendationCard(
                    ...
                    availableRooms: 3,
                    onTap: () {
                      Navigator.pushNamed(context, '/pilihanKamar1', arguments: {
                        'title': 'Kos Arliana',
                        'location': 'Jalan, Legok, Lohbener, Indramayu',
                        'price': '550rb/bln',
                        'rating': 4.2,
